...
<body>
  ...
  <div class="hc-container-row">
      <div class="hc-header">
          <div class="help-content cc-homepage">
          <div class="hc-content">
              <h1 style="font-weight: 600;"> How can we help you today? </h1>
          </div>
          <div class="form-help">
            <input placeholder=" Search all articles" name="search id="helpSearch" type="text" class="help-form-control"/>
            <span class="input-group-btn">
              <button class="help-btn" type="submit" onclick="">Search</button>
            </span>
          </div>
        </div>
      </div>
  </div>
<section class="help-titles" id="help-titles">
  <ul class="help-titles-wrapper">
    <li class="help-list">
      <a href="" class="help-data">
        <div class="help-category">
          <div class="help-cat-body">
            <div class="help-header-wrapper">
                <h1>Community</h1>
            </div>
            <div class="help-img-wrapper">
              <img src="/images/community.png">
            </div>
            <div class="help-body-wrapper">
              <p> Start discussions and find community answers </p>
            </div>
          </div>
        </div>
      </a>
      ...
      <a href="" class="help-data">
        <div class="help-category">
          <div class="help-cat-body">
            ...
            <div class="help-img-wrapper">
              <img src="/images/bank-of-info.png">
            </div>
            <div class="help-body-wrapper">
              <p> Have a question? Here are some of our most commonly asked questions </p>
            </div>
          </div>
        </div>
      </a>
      ...
      <a href="" class="help-data">
        <div class="help-category">
          <div class="help-cat-body">
            ...
            <div class="help-body-wrapper">
              <p> Watch videos and learn more about Shareity </p>
            </div>
          </div>
        </div>
      </a>
