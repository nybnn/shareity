...
<head>
  ...
  <meta content="Partners" name="generator">
...
<body>
  ...
  <div class="intro-header-part">
    <div class="intro-content-part">
      <div class="heading-jumbo" style="font-weight: 700; font-size: 35px">PARTNERS<br></div>
    </div>
  </div>
  <!--div class="intro-header-part2">
      <div class="intro-content-part2">
    ...
    <div class="row-part">
      ...
      <div class="col-lg-3">
        <div class="partner-pic">
          <a href="<?= $config->linkPartners($partner['link']); ?>">
