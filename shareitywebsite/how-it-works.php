...
<body>
  ...
  <!-- INTRO -->
  <div class="int-back back-hiw">
    <div class="int-content" style="padding: 100px 0px;">
      <div class="int-text">
        <p>HOW IT WORKS</p><br>
        Learn the Ropes<br><br>
        <p class="inline-p">
  ...
  <!-- BEGINNER'S GUIDE -->
  <div class="nw-content-backg">
    <h2 class="label-web" style="margin-bottom: 0px">Back-end Platform</h2>
    <?php foreach ($begin as $data) { ?>
    <div class="nw-content-wrap">
      <div class="nw-layout-grid about-grid nw-grid" style="">
        <div id="w-node-2" class="hiw-bullets">
          <div class="nw-section-wrap">
            <h3 class="nw-title"><?= $data['title'] ?></h3>
            <p class="nw-subt"><?= $data['subt'] ?></p>
          </div>
        </div>
        <a href="<?= $data['link'] ?>" class="mediabox" style="width: 80%; justify-self: left">
          <img class="blur ls-is-cached lazyloaded" data-src="<?= $config->linkAsset('images/' . $data['poster']); ?>"
            src="<?= $config->linkAsset('images/' . $data['poster']); ?>">
        </a>
      </div>
    </div>
    <?php } ?>
  ...
  <!-- WEB APP -->
  <div class="nw-content-backg" style="margin-bottom: 100px;">
    <h2 class="label-web" style="margin: 0px">Web-App Platform</h2>
    <?php foreach ($webapp as $data) { ?>
    <div class="nw-content-wrap">
      <div class="nw-layout-grid about-grid nw-grid" style="">
        <div id="w-node-2" class="hiw-bullets">
          <div class="nw-section-wrap">
