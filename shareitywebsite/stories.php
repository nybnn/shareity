...
<head>
  ...
  <meta content="Stories" property="twitter:title">
...
<body id="customer-stories">
  ...
  <!-- INTRO -->
  <div class="int-back back-stories">
    <div class="int-content" style="padding: 100px 0px;">
      <div class="int-text">
        <p>CUSTOMER STORIES</p><br>
        Don’t Take Our Word<br><br>
        <p class="inline-p">
          See what others are saying about Shareity
        </p>
      </div>
      <ul>
  ...
  <section id="case-study-container">
    <h2 class="label-web" style="margin-bottom: 40px">Client Case Studies</h2>
    <?php foreach ($stories as $data) { ?>
    <div class="pg-content case-study large-screen-centered">
      <div class="row-stories">
        <div class="col-md-5">
          <div class="case-study-content">
            <div class="logo-container" style="height: 2rem">
              <img class="logo" src="<?= $config->linkAsset('img/partners/' . $data['logo']); ?>">
            </div>
            <div class="quote-container">
              <span class="quotation">&ldquo;</span>
              <p class="quote"><?= $data['quote'] ?></p>
            </div>
            <div class="attribution-container">
              <img src="<?= $config->linkAsset('img/team/photos/' . $data['photo']); ?>">
              <div class="case-study-person-content">
                <div class="name-container">
                  <span class="name"><?= $data['person'] ?></span>
                  <span class="title"><?= $data['charge'] ?></span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-7">
          <div class="img-container">
            <img class="blur lazyload" data-src="<?= $config->linkAsset('images/' . $data['image']); ?>"
              src="<?= $config->linkAsset('images/' . $data['image']); ?>">
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Rate -->
  <section class="pg-content rate-site">
    <h2 class="label-web">How would you Rate your Experience with Shareity?</h2>
    <div class="scale-rating">
      <?php foreach ($rates as $data) { ?>
      <div class="number-container">
        <a href="/contact" target="_blank"><?= $data['num'] ?></a>
      </div>
      <?php } ?>
      <!-- 	<div class="number-container">
				<a href="https://members.shareity.me/#/register" target="_blank">2</a>
			</div>
			<div class="number-container">
				<a href="https://members.shareity.me/#/register" target="_blank">3</a>
			</div>
			<div class="number-container">
				<a href="https://members.shareity.me/#/register" target="_blank">4</a>
			</div>
			<div class="number-container">
				<a href="https://members.shareity.me/#/register" target="_blank">5</a>
			</div>
			<div class="number-container">
				<a href="https://members.shareity.me/#/register" target="_blank">6</a>
			</div>
			<div class="number-container">
				<a href="https://members.shareity.me/#/register" target="_blank">7</a>
			</div>
			<div class="number-container">
				<a href="https://members.shareity.me/#/register" target="_blank">8</a>
			</div>
			<div class="number-container">
				<a href="https://members.shareity.me/#/register" target="_blank">9</a>
			</div>
			<div class="number-container">
				<a href="https://members.shareity.me/#/register" target="_blank">10</a>
			</div> -->
    </div>
  </section>
  <!-- /.Rate -->
  ...
  <!-- BIG BUTTON -->
  <div class="">
    <div class="int-content" style="padding: 80px 0px; text-align: -webkit-center;">
      <a class="big-button-two" role="button" href="/our-story" target="_blank">
        Learn more about the story and people behind Shareity
      </a>
    </div>
  </div>
  <!-- /.BIG BUTTON -->
