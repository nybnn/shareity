...
<head>
  ...
  <meta content="Influencers" property="og:title">
  <meta content="Influencers" property="twitter:title">
...
<body>
  ...
  <!-- INTRO -->
  <div class="int-back back-infl">
    <div class="int-content" style="padding: 240px 0px;">
      <div class="int-text">INFLUENCERS<br><br>
        <!-- <p>Yup, It’s True!</p> -->
      </div>
      <!-- <ul>
  ...
  <div class="nw-container text-center my-4">
  <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSf-Zs_e0OsLWIzCmlA9rbM0bwYSV9CR4yZ5lZ8uiAKQssHaqQ/viewform?embedded=true" 
    width="640" height="2100" frameborder="0" marginheight="0" marginwidth="0" id="form-infl" >
    Loading…
  </iframe>
  </div>
  <!--  footer -->
