...
<head>
  ...
  <meta content="Confirmation" property="twitter:title">
...
<body>
  ...
  <div class="int-back back-conf">
    <div class="int-content-conf">
      <!-- <img src="/images/approved.png" alt="" class="cnf-imag"> -->
      <div class="heading-midle">YOUR DEMO HAS BEEN SCHEDULED!<br>
      <p>We look forward to meeting with you!<br>
      Please check your email for meeting details<br>
      <br>
      In the meantime, check out the <a class="links" href="/good-news">Good News</a> Blog <br>
      or <a class="links" href="/speaks">Shareity Speaks</a> Show</p>
      </div>
    </div>
  </div>
  <!--h2 class="label-b" style=" margin-top: 40px; margin-bottom: 40px;color: #1898D8;">CHECK US OUT ON SOCIAL</h2-->
<!-- LightWidget WIDGET -->
<!--div class="widgets-conf" style="width: 800px; justify-content:center; margin: auto">
  <script src="https://cdn.lightwidget.com/widgets/lightwidget.js"></script>
  <iframe src="//lightwidget.com/widgets/5d500812583c54e4bea3d5e7a19b84c9" scrolling="no"
