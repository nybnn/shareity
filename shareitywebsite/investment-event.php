...
<head>
  <meta charset="utf-8">
  <title>Shareity Investment Event 2022</title>
  <meta content="Shareity Investment Event 2022" property="og:title">
  <meta content="Shareity Investment Event 2022" property="twitter:title">
...
<!-- <script>
  ...
  var urlimg = encodeURIComponent('https://shareity.com/images/KH-and-Shareity-On-The-Move.jpg');
  var urltitle = encodeURIComponent('Shareity Investment Event 2022');
  var appid = '1514861518800355';
  console.log('AQUIIIIII::::',urlencode)
  console.log('AQUIIIIII::::',urlimg)
  console.log('AQUIIIIII::::',urltitle)
  console.log('AQUIIIIII::::',appid)
</script> -->

  <!-- INTRO -->
  <div class="int-back back-speak2" style="  background-image: url(/images/speaks-event-banner.jpg);">
    <div class="int-content-lat">
      <div class="int-text-lat" style="margin-bottom: 20px;">
        Shareity Investment Event 2022
      </div>
      <div class="airdate">
      Wed Mar 9, 2022 | 3-4pm EST
      </div>
      ...
      <div class="speak-social-icons col-4 p-0">
        <div class="speak-grid-item">
          ...
          onclick="window.open('https://www.facebook.com/dialog/feed?app_id=1514861518800355&link=https%3A%2F%2Fshareity.com%2Finvestment-event.php&name=Shareity%20Investment%20Event%202022&picture=https%3A%2F%2Fshareity.com%2Fimages%2FKH-and-Shareity-On-The-Move.jpg&redirect_uri=https://www.facebook.com','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');">
            <img src="/images/f-i.png" class="speak-imgsb">
          </a>
        </div>
        <div class="speak-grid-item">
          <a class="speak-event-icon" href="javascript: void(0);" onclick="window.open('http://twitter.com/share?url=https%3A%2F%2Fshareity.com%2Finvestment-event.php&text=Shareity%20Investment%20Event%202022','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');">
            <img src="/images/t-i.png" class="speak-imgsb">
          </a>
        </div>
        <div class="speak-grid-item">
          <a class="speak-event-icon" href="javascript: void(0);" onclick="window.open('https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fshareity.com%2Finvestment-event.php&title=Shareity%20Investment%20Event%202022','ventanacompartir', 'toolbar=0, status=0, width=650, height=450');">
    ...
    <div class="nw-layout-grid about-grid nw-grid" style="">
      <div id="w-node-2">
        <div class="nw-section-wrap" id="event-text">
          <p class="nw-subt" style="text-align:justify">Social media advertising has become noise resulting in desensitized users, who are pre-conditioned to ignore ads. Shareity has created a transformative, people centric, marketing approach called “Fundertising” that combines brand marketing, cause awareness, and social sharing, resulting in emotionally authentic calls to action. We are seeking up to $5 million in funding to activate current opportunities and scale existing operations.</p>
          <a type="button" data-toggle="modal" data-target="#RegistPopUp" class="btn-nb-2 btn"
            style="margin:30px 0px; padding: 0.375rem 2.75rem;">REGISTER NOW!</a>
          <!-- <a type="button"
  ...
  <div id="tohide">
    ...
    <div class="int-back back-speak2" style="background-image: url(/images/Registerclose.png); padding:120px 0px;">
      ...
      <script>
      var flipdown = new FlipDown(1646856000, {
        theme: 'light' // or dark
      });
