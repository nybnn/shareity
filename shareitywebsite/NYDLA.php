...
<head>
  <meta charset="utf-8">
  <title>Shareity + NYDLA</title>
  <meta content="Shareity + NYDLA" property="og:title">
  <meta content="Shareity + NYDLA" property="twitter:title">
  <meta content="width=device-width, initial-scale=1" name="viewport">
  <meta content="Shareity + NYDLA" name="generator">
...
<body>
  ...
  <div class="int-back back-nydla">
    <div class="">
    <h2 class="label-web" style=" margin-top: 50px; font-weight: 500; color:white">Book a Demo and Receive 500 Free Credits!</h2>
      <div id="nydlarow" class="row">
        <div class="col-lg-4 col-sm-4 alignment">
          <img class="img-nydla" src="/images/nydla-logo.png">
        </div>
        <div class="col">
        <!-- Start of Meetings Embed Script (NYDLA) -->
          <div id="nydlameet" class="meetings-iframe-container" data-src="https://meetings.hubspot.com/shareity/nydla?embed=true"></div>
          <script type="text/javascript" src="https://static.hsappstatic.net/MeetingsEmbed/ex/MeetingsEmbedCode.js"></script>
        <!-- End of Meetings Embed Script (NYDLA) -->
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    region: "na1",
    portalId: "2675419",
    formId: "ce56b028-4ddd-4b01-b816-acf3aa984bd2"
  });
  </script>
  <img class="wh-bx" src="/images/white-box.png" >
  </div> -->
