...
<body>
  ...
  <div class="section" style="text-align: -webkit-center;">
    <div class="cst-header-wrap">
      <section id="customer-section" class="customer-section ">
        <div class="cst-row">
          <div class="w-col w-col-6  cc-bigger-light col-pad" style="text-align: left;">
            <h1 class="nw-title text-center" style=" color:#04aded font-size: 2.875rem; line-height: 1.30435em;">
            <strong style="color:#04aded">Have Questions About Shareity?</strong><br></h1>
            <p class="nw-subt">
              Want to learn more about how you can advertise for good, fundraise for charity, and receive tremendous
              exposure? Get in touch with our team below!</p>
          </div>
          <div class="w-col w-col-6 cc-bigger-light" style=" text-align: -webkit-center;">
            <img src="/images/Steve-cs.png" alt="" class="cst-imag">
          </div>
        </div>
      </section>
    </div>

    <div class="cst-numbers">
      <ul class="cst-numbers-wrapper">
        <li class="cst-slider-slide">
          <div class="cst-numbers-block" >
            <img class="cst-block-icon" src="/images/Messages@2x.webp" alt="Messages">
            <h5  id="chatcard" class="cst-block-header" >Chat with us</h5>
            <div data-id="ePBU_rJ2Abs" class="cst-cta-container livechat_button">
              <a class="cst-small-primary" href="#" onclick="window.HubSpotConversations.widget.open();">Chat Now!</a>
            </div>
          </div>
        </li>
        <li class="cst-slider-slide">
          <div class="cst-numbers-block">
            <img class="cst-block-icon" src="/images/Date@2x.webp" alt="Messages">
            <h5 class="cst-block-header">Book a meeting</h5>
            <div class="cst-cta-container">
              <a class="cst-small-primary" href="/book-a-demo">Book a Demo</a>
            </div>
          </div>
        </li>
      </ul>
