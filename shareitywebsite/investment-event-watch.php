...
<body>
  ...
  <!-- INTRO -->
  <!-- Counter Down -->
  <div class="int-back back-speak2" style="background-image: url(/images/landing-background.jpg); padding:200px 0px;">
  ...
  <div class="container py-5 text-center">
    <iframe id="speakevent-video-frame" width="700px" height="400px" src="https://www.youtube.com/embed/IL76jLA0zso?&autoplay=1" title="Investment Event" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>

  <!-- /.Live Embed -->

  <div id="speak-live-form" class="backfa" style="padding:40px">
    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfANN7v-CUoz7EoC8isC9jxTxrI7lbYGLh2jtp-85p-d-n40w/viewform?embedded=true" width="640" height="750px" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
  </div>
